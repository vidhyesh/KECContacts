...
public class ShowSingleRecordActivity extends Activity {
    HttpParse httpParse = new HttpParse();
    ProgressDialog pDialog;

    // Http Url For Filter Student Data from Id Sent from previous activity.
    String HttpURL = "http://192.168.137.1/Student/FilterStudentData.php";

    // Http URL for delete Already Open Student Record.
    String HttpUrlDeleteRecord = "http://192.168.137.1/Student/DeleteStudent.php";
    ...
    public void onBackPressed() {
        Intent i = new Intent(getApplicationContext(), edit.calender.ShowAllStudentsActivity.class);
        startActivity(i);
        finish();
    }
}