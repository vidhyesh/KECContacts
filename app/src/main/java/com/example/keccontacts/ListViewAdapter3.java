...
public class ListViewAdapter3 extends BaseAdapter {
	...
	public ListViewAdapter3(Context context, List<StaffClass> worldpopulationlist) {
		mContext = context;
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			...
			holder.rank = (TextView) view.findViewById(R.id.names);
			holder.country = (TextView) view.findViewById(R.id.mails);
			holder.population = (TextView) view.findViewById(R.id.mobiles);
		...
		holder.country.setText(worldpopulationlist.get(position).getMobile());
		holder.population.setText(worldpopulationlist.get(position).getMail());
		...
		view.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View arg0) {
				...
				Intent i = new Intent(mContext, MultiSelect3.class);
				i.putExtra("rank",(worldpopulationlist.get(position).getId()));
				i.putExtra("dept",(worldpopulationlist.get(position).getDept()));
				i.putExtra("str",str);
				//i.putExtra("dept","CSE");
