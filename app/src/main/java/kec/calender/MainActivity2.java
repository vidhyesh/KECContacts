...
public class MainActivity2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userList.size() != 0) {
            ...
            ListAdapter adapter = new SimpleAdapter(MainActivity2.this, userList, R.layout.view_user_entry, new String[] {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.csearch) {
            Toast.makeText(getApplicationContext(), "clicked search",
                    Toast.LENGTH_LONG).show();
            Intent i1 = new Intent(this,kec.calender.SearchActivity.class);
            startActivity(i1);
            return true;
        }
        if (id == R.id.home) {
            Toast.makeText(getApplicationContext(), "Home",
                    Toast.LENGTH_LONG).show();
            Intent i1 = new Intent(this,login.calender.activity.SelectionActivity.class);
            startActivity(i1);
            return true;
        }
    ...
    public void syncSQLiteMySQLDB() {
        ...
        client.post("http://192.168.137.1/sync/getusers.php", params, new AsyncHttpResponseHandler() {
            @Override
    ...
    public void updateMySQLSyncSts(String json) {
        ...
        client.post("http://www.devaraj.xyz/s/updatesyncsts.php", params, new AsyncHttpResponseHandler() {
        });
    }
    // Reload MainActivity2
